...
import de.learnlib.testsupport.example.mealy.ExampleBitVise.Input;
import de.learnlib.testsupport.example.mealy.ExampleBitVise.Output;
...
/**
 * This example encodes a small BitVise with a capacity of three elements and "push" and "pop" operations as Mealy
 * machine. Outputs are "ok", "empty" and "full".
 */
    public class ExampleBitVise extends DefaultMealyLearningExample<Input, Output> {

    public ExampleBitVise() {
    ...
    public static <S, T, A extends MutableMealyMachine<S, ? super Input, T, ? super Output>> A constructMachine(A fm) {
        ...
        String filePath = "/home/stefanos/Documents/NTUA/ModelLearning/learnlib/mealy-machines/ssh/bit-vise.dot";
    ...
    public static ExampleBitVise createExample() {
      return new ExampleBitVise();
    }
    public enum Input {
		I0,
		I1,
