...
/**
 * This example encodes a small DropBear with a capacity of three elements and "push" and "pop" operations as Mealy
 * machine. Outputs are "ok", "empty" and "full".
 */
    public class ExampleDropBear extends DefaultMealyLearningExample<Input, Output> {

    public ExampleDropBear() {
     ...
     */
        ...
        String filePath = "/home/stefanos/Documents/NTUA/ModelLearning/learnlib/mealy-machines/ssh/drop-bear.dot";
    ...
    public static ExampleDropBear createExample() {
      return new ExampleDropBear();
    }
    public enum Input {
		I0,
		I1,
