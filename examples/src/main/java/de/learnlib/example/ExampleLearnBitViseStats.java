...
import de.learnlib.testsupport.example.mealy.ExampleBitVise;
...
public final class ExampleLearnBitViseStats {

    private static final int EXPLORATION_DEPTH = 4;

    private ExampleLearnBitViseStats () {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ExampleBitVise bitviseExample = ExampleBitVise.createExample();
        MealyMachine<?, Input, ?, Output> mealy = bitviseExample.getReferenceAutomaton();
        Alphabet<Input> alphabet = bitviseExample.getAlphabet();
