...
import de.learnlib.testsupport.example.mealy.ExampleTCP_FreeBSD_Client;
...
public final class ExampleStefanos {

    private static final int EXPLORATION_DEPTH = 4;

    private ExampleStefanos () {
    ...
    public static void main(String[] args) throws IOException {
        ...
        ExampleTCP_FreeBSD_Client tcpExample = ExampleTCP_FreeBSD_Client.createExample();
